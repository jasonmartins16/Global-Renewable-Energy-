...
The "Pulse" Formula: 
Through reverse-engineering of urban energy datasets, the system utilizes the following weighted index for the Green Score:
Score_{Pulse} = (0.001 \times \text{Shortwave Radiation}) + (0.0333 \times \text{Wind Speed}_{100m})
